![TanStack Persist Header](https://github.com/tanstack/persister/raw/main/media/repo-header.png)

# [TanStack](https://tanstack.com) Persist v0
...
<a href="https://github.com/tanstack/persister/actions?persister=workflow%3A%22react-persist+tests%22">
  <img src="https://github.com/tanstack/persister/workflows/react-persist%20tests/badge.svg" />
</a>
<a href="https://npmjs.com/package/@tanstack/react-persist" target="\_parent">
  <img alt="" src="https://img.shields.io/npm/dm/@tanstack/react-persist.svg" />
</a>
<a href="https://bundlephobia.com/result?p=@tanstack/react-persist@latest" target="\_parent">
  <img alt="" src="https://badgen.net/bundlephobia/minzip/@tanstack/react-persist@latest" />
</a>
<a href="#badge">
...
<a href="https://github.com/tanstack/persister" target="\_parent">
  <img alt="" src="https://img.shields.io/github/stars/tanstack/react-persist.svg?style=social&label=Star" />
</a>
...
## Visit [tanstack.com/persist](https://tanstack.com/persist) for docs, guides, API and more!

You may know **TanStack Persist** by our adapter names, too!

- [**React Persist**](https://tanstack.com/persist/latest/docs/framework/react/react-persist)
- Solid Persist - Coming soon! (After React Persist is more fleshed out)
- Angular Persist - needs a contributor!
- Preact Persist - Coming soon! (After React Persist is more fleshed out)
- Svelte Persist - needs a contributor!
- Vue Persist - needs a contributor!
...
npm install @tanstack/persist # no framework, just vanilla js
```
